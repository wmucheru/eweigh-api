<div class="clearfix">
	...
	<div class="modal fade" id="agModal" tabindex="-1" role="dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body clearfix">
					<?php 
						...
						echo form_open('users/groups/create', $options);
					?>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						  <textarea name="group_definition" id="group-definition" col="40" rows="4"
